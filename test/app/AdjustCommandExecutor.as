package {
    ...
    public class AdjustCommandExecutor {
        public static var basePath:String; // Made as static to be accessible from delegates
        ...
        private function config(params:Object):void {
            ...
            //if (params['sdkPrefix'] != null) {
            //var sdkPrefix:String = getFirstParameterValue(params, 'sdkPrefix');
