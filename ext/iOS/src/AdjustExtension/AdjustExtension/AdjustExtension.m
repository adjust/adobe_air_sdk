...
void setNamedFunction(FRENamedFunction* namedFunction, const uint8_t* name, FREFunction function) {
  NSLog(@"setting named function %s -> %s", &name, &function);
