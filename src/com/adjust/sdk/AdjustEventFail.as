package com.adjust.sdk {
    public class AdjustEventFail {
        ...
        public function AdjustEventFail(message:String, timestamp:String, adid:String, eventToken:String, jsonResponse:String, willRetry:Boolean) {
