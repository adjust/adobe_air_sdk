...
AdjustIo.swc:
	$(COMPC) -swf-version 13 -source-path src -include-classes com.adeven.adjustio.AdjustIo -external-library-path $(FLEX_SDK_PATH)/frameworks/libs/air/airglobal.swc -output ./$(BUILD_DIR)/AdjustIo.swc
